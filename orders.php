    ...
    <?php
        ...
        if(mysqli_num_rows($select_orders) > 0){
            while($fetch_orders = mysqli_fetch_assoc($select_orders)){
                ...
                $address_parts[count($address_parts) - 2] = 'İstanbul'; // Şehir bilgisini güncelle
                $address_parts[0] = trim(str_replace('flat no. ', '', $address_parts[0])); // "flat no." kısmını sil
                $address_formatted = implode(', ', $address_parts);
    ?>
    <div class="box">
        ...
        <p> Adres: <span><?php echo $address_formatted; ?></span> </p>
