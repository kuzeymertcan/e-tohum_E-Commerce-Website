...
if(isset($_POST['update_quantity'])){
    ...
    $message[] = 'Alışveriş sepeti güncellendi!';
}
...
<section class="heading">
    ...
    <p> <a href="home.php">Ana Sayfa</a> / Alışveriş Sepetim </p>
</section>
...
<section class="shopping-cart">
    ...
    ?>
    <div class="box">
        <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Bu ürünü sepetten çıkarmak istiyor musunuz?');"></a>
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('Tüm ürünleri sepetten çıkarmak istiyor musunuz?');">Hepsini Sil</a>
    </div>

    <div class="cart-total">
        <p>Genel toplam: <span><?php echo $grand_total; ?> ₺</span></p>
        <a href="shop.php" class="option-btn">Alışverişe Devam Et</a>
        <a href="checkout.php" style="padding: 12px 10px 12px 10px; margin-left: 10px;" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">Ödeme İşlemine Geç</a>
    </div>
