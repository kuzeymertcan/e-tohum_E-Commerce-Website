...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" required placeholder="Ürün adını güncelleyin" name="name">
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price']; ?>" required placeholder="Ürün fiyatını güncelleyin" name="price">
   <textarea name="details" class="box" required placeholder="Ürün açıklamasını güncelleyin" cols="30" rows="10"><?php echo $fetch_products['details']; ?></textarea>
   <input type="file" accept="image/jpg, image/jpeg, image/png" class="box" name="image">
   <input type="submit" value="Ürünü Güncelle" name="update_product" class="btn">
   <a href="admin_products.php" class="option-btn">Geri Git</a>
</form>

<?php
      }
   }else{
      echo '<p class="empty">Güncellenecek ürün seçilmedi!</p>';
   }
?>
